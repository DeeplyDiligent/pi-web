...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.autoReadResponses": "Read completed responses aloud, then listen for a reply",
    "settings.speechUnsupported": "Read aloud is not supported by this browser",
    ...
    "chat.refreshCopilot": "Refresh from Copilot",
    "chat.refreshingCopilot": "Refreshing Copilot…",
    "chat.copilotLastChecked": "Copilot checked at {time}",
    ...
    "chat.attachmentUploading": "Uploading attachments…",
    "chat.attachmentUploadFailed": "Attachment upload failed.",
    "chat.speechStart": "Start voice input",
    "chat.speechStop": "Stop recording",
    "chat.speechCancel": "Cancel voice input",
    "chat.speechListening": "Listening…",
    "chat.speechStarting": "Starting local live transcription…",
    "chat.speechTranscribing": "Finishing transcription…",
    "chat.speechFailed": "Speech transcription failed.",
    "chat.speechNotRecognized": "No speech was recognized.",
    ...
    "chat.chooseWorkspace": "Choose a workspace for your new thread",
    "chat.noWorkspaces": "No workspaces yet. Choose a folder to get started.",
    ...
    "i18n.readAloud": "Read response aloud",
    "i18n.stopReading": "Stop reading",
    "i18n.fork": "Fork",
    "i18n.stoppingForEdit": "Stopping…",
    "i18n.editFromHere": "Edit from here",
    "i18n.editFromHereTitle": "Stop the current run and edit from here — branches within this session",
