...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.autoReadResponses": "自动朗读已完成的回复，然后聆听语音答复",
    "settings.speechUnsupported": "此浏览器不支持朗读功能",
    ...
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    "chat.refreshCopilot": "从 Copilot 刷新",
    "chat.refreshingCopilot": "正在刷新 Copilot…",
    "chat.copilotLastChecked": "Copilot 检查时间：{time}",
    ...
    "chat.attachmentUploading": "正在上传附件…",
    "chat.attachmentUploadFailed": "附件上传失败。",
    "chat.speechStart": "开始语音输入",
    "chat.speechStop": "停止录音",
    "chat.speechCancel": "取消语音输入",
    "chat.speechListening": "正在聆听…",
    "chat.speechStarting": "正在启动本地实时转写…",
    "chat.speechTranscribing": "正在完成转写…",
    "chat.speechFailed": "语音转写失败。",
    "chat.speechNotRecognized": "未识别到语音。",
    "chat.previewImage": "预览图片",
    "chat.filterModels": "筛选模型…",
    "chat.noMatchingModels": "没有匹配的模型",
    "chat.moreControls": "更多控件",
    "chat.newThread": "新建会话",
    "chat.chooseWorkspace": "为新会话选择工作区",
    "chat.noWorkspaces": "暂无工作区。请选择一个文件夹以开始。",
