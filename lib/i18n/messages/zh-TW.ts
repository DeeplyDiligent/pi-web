...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.plugins": "外掛",
    "common.signOut": "登出",
    "chat.refreshCopilot": "從 Copilot 重新整理",
    "chat.refreshingCopilot": "正在重新整理 Copilot…",
    "chat.copilotLastChecked": "Copilot 檢查時間：{time}",
    "chat.speechCancel": "取消語音輸入",
    "chat.speechFailed": "語音辨識失敗",
    "chat.speechListening": "正在聆聽…",
    "chat.speechNotRecognized": "未辨識到語音，請再試一次。",
    "chat.speechStart": "開始語音輸入",
    "chat.speechStarting": "正在啟動麥克風…",
    "chat.speechStop": "停止語音輸入",
    "chat.speechTranscribing": "正在轉錄…",
    "common.settings": "設定",
    "settings.title": "設定",
    "settings.general": "一般",
    ...
    "settings.autoReadResponses": "自動朗讀已完成的回覆，然後聆聽語音答覆",
    "settings.speechUnsupported": "此瀏覽器不支援朗讀功能",
    ...
    "directoryPicker.folderName": "資料夾名稱",
    ...
    "chat.attachmentUploading": "正在上傳附件…",
    "chat.attachmentUploadFailed": "附件上傳失敗。",
    "chat.previewImage": "預覽圖片",
    "chat.filterModels": "篩選模型…",
    "chat.noMatchingModels": "找不到相符的模型",
    "chat.moreControls": "更多控制項",
    "chat.newThread": "新增對話",
    "chat.chooseWorkspace": "為新對話選擇工作區",
    "chat.noWorkspaces": "尚無工作區。請選擇一個資料夾以開始。",
    ...
    "i18n.readAloud": "朗讀回覆",
    "i18n.stopReading": "停止朗讀",
    "i18n.fork": "建立副本",
    "i18n.stoppingForEdit": "正在停止…",
