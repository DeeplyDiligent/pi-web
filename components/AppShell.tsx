      ...
      <div style={{ padding: "8px", flexShrink: 0, display: "flex", justifyContent: "space-between", gap: 4 }}>
        ...
        {onSignOut && (
          <button
            ...
            aria-label={translate("common.signOut")}
            style={{ flex: 1, height: 32, padding: 0, background: "none", border: "none", borderRadius: 9, color: "var(--text-muted)", cursor: "pointer", fontSize: 12 }}
          >
